                    ...
                    <div class="card mb-4">
                        <div class="card-header border-0">
                            <div class="d-flex justify-content-between">
                                <h3 class="card-title">Stock Chart</h3> <a href="javascript:void(0);" class="link-primary link-offset-2 link-underline-opacity-25 link-underline-opacity-100-hover">View Report</a>
                            </div>
                        </div>
                        <div class="card-body">
                            <div class="position-relative mb-4">
                                <div class="toolbar">
                                    <button id="one_month" class="active btn btn-primary">
                                        1M
                                    </button>

                                    <button id="six_months" class="btn btn-primary">
                                        6M
                                    </button>

                                    <button id="one_year" class="btn btn-primary">
                                        1Y
                                    </button>

                                    <button id="ytd" class="btn btn-primary">
                                        YTD
                                    </button>
...
//          ]
        ...
        var stock_chart = new ApexCharts(document.querySelector("#stock_chart"), stock_chart_options);
        stock_chart.render();
        ...
        document.querySelector('#one_month')
